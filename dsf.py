    ...
    def search(self, save_images=False):
        ...
        while len(self.open_set) > 0:
            ...
            for order in self.order_list:
                ...
                # get new point from map and update
                ...
                # update open set and adjust point order
                self.open_set.discard(new_point)
...
def main():
    rand_map = RandMap(map_size=15, obstacle_num=4)
    rand_map.plot_map()
    obj = DSF(rand_map)
